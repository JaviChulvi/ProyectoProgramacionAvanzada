...
public abstract class Cliente implements ObjetosConFecha, Serializable {
    ...
    public Cliente(String nombre, String NIF, Direccion direccion, String email, LocalDate fechaDeAlta, Tarifa tarifa) {
        this.nombre = nombre;
        this.NIF = NIF;
        ...
        this.llamadasSinFacturar = new ArrayList<Llamada>();
    }
